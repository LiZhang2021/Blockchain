 ...
 * 英文论文的作者名称，采用 "first name首字母.last name" 形式，首字母大写，例如 
	...
	<font color=red>紧密书写，不用空格隔开</font>；当英文作者姓名有三个时采用"first name"首字母."middle name"首字母."last name"形式，且首字母大写，例如<font color = blue>Brian M. Oki --> B.M.Oki</font>；
 ...
 * 对于论文，需要在 发表时间 之后，添加 thesis 标识，例如
